        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-200 text-sm">
            <li className="flex items-center gap-2">
              <MdEmail className="text-[#FACC15]" /> raishoukat033@gmail.com
            </li>
            <li className="flex items-center gap-2">
              <MdPhone className="text-[#FACC15]" /> +92 347 3127706
            </li>
            <li className="flex items-center gap-2">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            {[
              ...
              { href: "https://www.linkedin.com/in/shoukat-rai-750507245/", icon: <FaLinkedin /> },
